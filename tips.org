...
specific tool. This function supports [[https://github.com/psf/black][black]], [[https://clang.llvm.org/docs/ClangFormat.html][clang-format]] or the LSP itself.  You can locally set
...
*** Auto formatting
See [[Buffer formatting]]. In addition to that, the variable ~my/python-isort-on-save~ will activate
[[https://github.com/timothycrosley/isort/][isort]] when saving.
